...
--
myWorkspaces = ["1:web","2:term","3:code","4:im","5:media", "6:net"] ++ map show [7..9]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  -- Search
  , ((modMask, xK_s),
     SM.submap $ searchEngineMap $ S.promptSearchBrowser chusoXPConfig "firefox" )
